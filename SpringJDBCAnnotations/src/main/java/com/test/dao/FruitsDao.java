...
public class FruitsDao {
	...
	private final String update_sql = "update fruits set f_name = ?, f_price= ?, f_quantity= ?";
...
{
	return jdbcTemplate.update(update_sql,obj.getId(), obj.getName(), obj.getPrice(), obj.getQuantity()) >0;
}
